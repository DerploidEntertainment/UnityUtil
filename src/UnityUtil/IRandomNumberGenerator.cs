...
public interface IRandomNumberGenerator
{
    ...
    /// <param name="exclusiveMax">The exclusive upper bound of the random number returned. maxValue must be greater than or equal to <paramref name="inclusiveMin"/>.</param>
    /// <returns>
