...
namespace UnityEngine {
    ...
    public class DestroyZone : MonoBehaviour {
        ...
        [Tooltip("If true, then the GameObject of the Rigidbody attached to the triggering Collider will be destroyed.  If false, then only the GameObject of the trigger Collider itself will be destroyed.")]
        public bool DestroyAttachedRigidbody = true;
        [Tooltip("If non-null, this value will be used to filter OnTriggerEnter events to only those where the attached Rigidbody of the enterring Collider MATCHES or DOES NOT MATCH this Tag, depending on the value of " + nameof(DestroyZone.FilterIsBlacklist) + ".")]
