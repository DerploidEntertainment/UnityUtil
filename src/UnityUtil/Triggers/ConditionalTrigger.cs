...
namespace UnityEngine.Triggers {
    ...
    public abstract class ConditionalTrigger : MonoBehaviour {
        ...
        private const string TRUE_MSG = nameof(BecameTrue) + " is raised if the trigger's condition WAS false and BECAME true. " + nameof(StillTrue) + " is raised if the trigger's condition WAS true and STILL IS true (e.g., during a call to " + nameof(TriggerState) + ".";
        private const string FALSE_MSG = nameof(BecameFalse) + " is raised if the trigger's condition WAS true and BECAME false. " + nameof(StillFalse) + " is raised if the trigger's condition WAS false and STILL IS false (e.g., during a call to " + nameof(TriggerState) + ".";
