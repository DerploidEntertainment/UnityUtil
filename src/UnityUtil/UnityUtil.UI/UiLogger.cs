...
internal static class UiLoggerExtensions
{
    ...
    public static void AudioMixerParameterFromPrefs(this MEL.ILogger logger, float value, string parameter, AudioMixer audioMixer, string preferencesKey) =>
        logger.LogWarning(new EventId(id: 0, nameof(AudioMixerParameterFromPrefs)), $"Loading {{{nameof(value)}}} of {{{nameof(parameter)}}} of {{{nameof(audioMixer)}}} from {{{nameof(preferencesKey)}}}", value, parameter, audioMixer.name, preferencesKey);
    ...
    public static void AudioMixerParameterFromInspector(this MEL.ILogger logger, float value, string parameter, AudioMixer audioMixer, string preferencesKey) =>
        logger.LogWarning(new EventId(id: 0, nameof(AudioMixerParameterFromInspector)), $"Not using local preferences or key {{{nameof(preferencesKey)}}} could not be found. Loading {{{nameof(value)}}} of {{{nameof(parameter)}}} directly from {{{nameof(audioMixer)}}} instead", preferencesKey, value, parameter, audioMixer);
    ...
    public static void AudioMixerParameterValueSaved(this MEL.ILogger logger, float value, string parameter, AudioMixer audioMixer, string preferencesKey) =>
        logger.LogWarning(new EventId(id: 0, nameof(AudioMixerParameterValueSaved)), $"Saved {{{nameof(value)}}} of {{{nameof(parameter)}}} of {{{nameof(audioMixer)}}} to {{{nameof(preferencesKey)}}}", value, parameter, audioMixer.name, preferencesKey);

    public static void AudioMixerParameterPrefDeleted(this MEL.ILogger logger, string preferencesKey) =>
        logger.LogWarning(new EventId(id: 0, nameof(AudioMixerParameterPrefDeleted)), $"Deleted {{{nameof(preferencesKey)}}}", preferencesKey);

    public static void CurrentSafeArea(this MEL.ILogger logger, RectTransform rectTransform) =>
        logger.LogWarning(new EventId(id: 0, nameof(CurrentSafeArea)),
    ...
    public static void NewSafeArea(this MEL.ILogger logger, RectTransform rectTransform) =>
        logger.LogWarning(new EventId(id: 0, nameof(NewSafeArea)),
    ...
    public static void UiBreakpointUpdating(this MEL.ILogger logger, BreakpointMode mode, BreakpointMatchMode matchMode) =>
        logger.LogWarning(new EventId(id: 0, nameof(UiBreakpointUpdating)),
    ...
    public static void SplashScreenInitializing(this MEL.ILogger logger) =>
        logger.LogWarning(new EventId(id: 0, nameof(SplashScreenInitializing)), "Initializing splash screen...");

    public static void SplashScreenDrawing(this MEL.ILogger logger) =>
        logger.LogWarning(new EventId(id: 0, nameof(SplashScreenDrawing)), "Starting to draw splash screen...");

    public static void SplashScreenStopping(this MEL.ILogger logger) =>
        logger.LogWarning(new EventId(id: 0, nameof(SplashScreenStopping)), "Stopping splash screen...");
